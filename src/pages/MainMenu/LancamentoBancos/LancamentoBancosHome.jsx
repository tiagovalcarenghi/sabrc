...
import GridLancamentoBancos from "../../../components/MainMenu/LancamentoBancos/GridLancamentoBancos";
import { getDateFormat, isEligible } from "../../../util/utils";
import AppMenu from "../../AppNavBar/AppMenu";


const LancamentoBancosHome = (props) => {
    ...
    useEffect(() => {
        setLancamentoContabilDb(JSON.parse(localStorage.getItem("lancamentosbancobase_db")));
    ...
    const deleteLancamentoContabil = (data) => {
        let items = JSON.parse(localStorage.getItem("lancamentosbancobase_db"));
        items.map((item) => {
        ...
        localStorage.setItem("lancamentosbancobase_db", JSON.stringify(items));
    ...
    return (
        <>
            <AppMenu>
                <GridLancamentoBancos
                    lancamentosbancobase_db={lancamentoContabilDb}
...
export default LancamentoBancosHome;
